...
$UPN = Read-Host "Enter the User Principal Name of the account which is suspected of being compromised"
    ...
    If($DisableAzureADUserDisableConfirm -like "Yes") {
        ...
        $DisableAzureADUsersDevices = Read-host "Do you want to disable $UPN's Azure Active Directory devices from connecting to Microsoft 365? (Yes/No)"
        If($DisableAzureADUsersDevices -like "Yes") {
